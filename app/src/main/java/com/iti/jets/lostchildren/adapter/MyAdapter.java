...
//                        detailsFragment, "details").commit();
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(current.getLostUserId().getLastName().toString() == null ){
            ...
            holder.reporter.setText(" "+current.getLostUserId().getFirstName());
        }
        ...
        Log.i("PROFILE",imgeURL+current.getImageUrl());
        Picasso.get().load(imgeURL+current.getImageUrl()).placeholder(R.drawable.placeholder).into(holder.img);
        Picasso.get().load(userImageURL+current.getLostUserId().getImageUrl()).placeholder(R.drawable.placeholder).into(holder.imgBy);
    }
